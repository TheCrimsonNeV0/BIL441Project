...
KINGS_GAMBIT_ACCEPTED = Opening("e2e4 e7e5 f2f4 e5f4 g1f3 g7g5", -0.4)  # Standart Variation | Stockfish Evaluation: -0.4
KINGS_GAMBIT_DECLINED = Opening("e2e4 e7e5 f2f4 f8c5 g1f3 d7d6", 0.0)  # Standart Variation | Stockfish Evaluation: 0.0
...
OPENINGS = [ITALIAN_OPENING_1, ITALIAN_OPENING_2, RUY_LOPEZ_OPENING_1, RUY_LOPEZ_OPENING_2, CARO_KANN_OPENING_1,
            ...
            LONDON_SYSTEM_GAMBIT_DECLINED, LONDON_SYSTEM_GAMBIT_ACCEPTED, FRENCH_DEFENSE,
            KINGS_GAMBIT_ACCEPTED, KINGS_GAMBIT_DECLINED]
